 ...
 * 
 * ver 2: removed / at the end of http://localhost:8082/#!/my-posts/
 * on lines 94 and 139 
 * ver 3: for FR 4-4
...
describe('Locate page elements', function(){  
    ...
    beforeEach(() => {
      ...
      cy.wait(100);
      cy.request('http://localhost:8082/posts').then((response) => {
...
describe('All Posts and comments', function(){   
    ...
    beforeEach(() => {
      cy.visit('http://localhost:8082/#!/all-posts');  
...
describe('User posts', function(){   
  ...
  beforeEach(() => {
      ...
      cy.request('http://localhost:8082/users').then((response) => {
  ...
  it("FR 3-7  Selects My Posts ", function(){
    ...
    cy.visit('http://localhost:8082/#!/my-posts');
 ...
 describe('Comment and post form page elements', function(){   
    ...
    it("FR 4-4 Comment Form in Single Post view", function(){
       ...
       let pid = a_post[0].id;
       cy.visit("http://localhost:8082/#!/posts/"+pid); 
       cy.wait(100);
       cy.get("form");
...
describe('Show comments in Single Post view', function(){   
    ...
    beforeEach(() => {
          ...
          cy.request('http://localhost:8082/comments').then((response) => {
